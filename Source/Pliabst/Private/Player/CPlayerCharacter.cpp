...
void ACPlayerCharacter::PawnClientRestart()
{
	...
	{
		UEnhancedInputLocalPlayerSubsystem* InputSubsytem = OwningPlayerController->GetLocalPlayer()->GetSubsystem<UEnhancedInputLocalPlayerSubsystem>();
		if (InputSubsytem)
		{
			InputSubsytem->RemoveMappingContext(GameplayInputMappingContext);
			InputSubsytem->AddMappingContext(GameplayInputMappingContext, 0);
		}
	}
}
